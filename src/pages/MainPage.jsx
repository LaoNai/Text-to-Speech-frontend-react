      ...
      <div class="root">
        <div class="leftbox">
          ...
          <div to="/novel" class="novel">
            ...
            <p>
              小说 <span class="arrow">{}</span>
            </p>
          </div>
          <div v-if="isDropdownOpen" class="dropdown">
            <router-link to="/internetsearch" class="dropdown_item">
              联网搜索
            </router-link>
            <router-link to="/load" class="dropdown_item">
              本地导入
            </router-link>
            <router-link to="/novel" class="dropdown_item">
              小说阅读
            </router-link>
          </div>
          <router-link to="/bookshelf" class="bookshelf">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="25"
          ...
          <router-link to="/test" class="history">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="25"
          ...
          <div class="user_info">
            <div class="user_avatar">
              {/* <!-- 头像 --> */}
              <router-link to="/user" class="user1">
                U
              </router-link>
            </div>
            <router-link to="/user" class="username">
              {/* <!-- 用户名 --> */}
              <p>用户名</p>
            </router-link>
          </div>
